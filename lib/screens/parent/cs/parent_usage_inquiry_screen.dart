...
class ParentUsageInquiryScreen extends StatefulWidget {
  const ParentUsageInquiryScreen({super.key});

  @override
  State<ParentUsageInquiryScreen> createState() =>
      _ParentUsageInquiryScreenState();
}

class _ParentUsageInquiryScreenState extends State<ParentUsageInquiryScreen> {
  // 현재 선택된 카테고리 (0: 기능 문의, 1: 계정 관리, 2: 기록 관리, 3: 로그인/오류)
