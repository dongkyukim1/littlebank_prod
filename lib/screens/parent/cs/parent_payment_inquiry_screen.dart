...
class ParentPaymentInquiryScreen extends StatefulWidget {
  const ParentPaymentInquiryScreen({super.key});

  @override
  State<ParentPaymentInquiryScreen> createState() =>
      _ParentPaymentInquiryScreenState();
}

class _ParentPaymentInquiryScreenState
    extends State<ParentPaymentInquiryScreen> {
