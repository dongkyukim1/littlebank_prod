...
import 'change/parent_bank_selection_modal.dart';
import 'change/parent_account_verification_modal.dart';
import '../../../../services/auth_service.dart';
import '../../../../mixins/pin_modal_mixin.dart';

class ParentAccountLinkScreen extends StatefulWidget {
  const ParentAccountLinkScreen({super.key});

  @override
  State<ParentAccountLinkScreen> createState() => _ParentAccountLinkScreenState();
}

class _ParentAccountLinkScreenState extends State<ParentAccountLinkScreen>
    with PinModalMixin {
  // 선택된 은행/증권사
  ...
  // 은행/증권사 리스트 (사용자 지정 순서) - 실제 존재하는 로고 파일들로 매핑
  final List<Map<String, String>> _banks = [
    {'name': '국민', 'logo': 'assets/logos/kb_bank.png', 'code': '004'},
    {'name': '신한', 'logo': 'assets/logos/shinhan_bank.png', 'code': '088'},
    {'name': '농협', 'logo': 'assets/logos/nh_bank.png', 'code': '011'},
    {'name': '하나', 'logo': 'assets/logos/hana_bank.png', 'code': '081'},
    {'name': '우리', 'logo': 'assets/logos/woori_bank.png', 'code': '020'},
    {'name': '카카오', 'logo': 'assets/logos/kakao_bank.png', 'code': '090'},
    {'name': '경남', 'logo': 'assets/logos/kyongnam_bank.png', 'code': '039'},
    {'name': '광주', 'logo': 'assets/logos/gwangju_bank.png', 'code': '034'},
    {'name': '기업', 'logo': 'assets/logos/ibk_bank.png', 'code': '003'},
    {'name': '대구', 'logo': 'assets/logos/daegu_bank.png', 'code': '031'},
    {'name': '부산', 'logo': 'assets/logos/busan_bank.png', 'code': '032'},
    {'name': 'KDB 산업', 'logo': 'assets/logos/KBD_BANK.png', 'code': '002'},
    {'name': '수협', 'logo': 'assets/logos/suhyup_bank.png', 'code': '007'},
    {'name': '신협', 'logo': 'assets/logos/shinhyup.png', 'code': '048'},
    {'name': 'KEB 외환', 'logo': 'assets/logos/keb_bank.png', 'code': '005'},
    {'name': '우체국', 'logo': 'assets/logos/우체국_bank.png', 'code': '071'},
    {'name': '전북', 'logo': 'assets/logos/jeonbuk_bank.png', 'code': '037'},
    {'name': '제주', 'logo': 'assets/logos/jeju_bank.png', 'code': '035'},
    {'name': '축협', 'logo': 'assets/logos/축협_bank.png', 'code': '012'},
    {'name': '케이뱅크', 'logo': 'assets/logos/kbank.png', 'code': '089'},
    {'name': '한국시티', 'logo': 'assets/logos/citi_bank.png', 'code': '027'},
  ...
  final List<Map<String, String>> _securities = [
    ...
    {'name': '삼성증권', 'logo': 'assets/logos/samsung_securities.png', 'code': '240'},
    {'name': '한국투자증권', 'logo': 'assets/logos/korea_investment.png', 'code': '243'},
    ...
    {'name': '신한투자증권', 'logo': 'assets/logos/shinhan_investment.png', 'code': '278'},
    {'name': 'KB증권', 'logo': 'assets/logos/kb_securities.png', 'code': '218'},
    {'name': '토스증권', 'logo': 'assets/logos/toss_securities.png', 'code': '271'},
    {'name': '카카오페이증권', 'logo': 'assets/logos/kakaopay_securities.png', 'code': '288'},
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(
          _linkedAccount?['isVerified'] == 'true' ? '내 계좌' : '계좌 연결',
          style: TextStyle(
            color: Colors.black,
            fontSize: 16,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '회원가입 때 입력했던 이름과 동일한 예금주의 계좌만 연결할 수 있어요',
                          textAlign: TextAlign.left,
                          style: TextStyle(
  ...
  void _onAccountChangePressed() {
    ...
    showPinInputModalOnly(
      ...
      onPinVerified: (pin) {
        print('[ParentAccountLinkScreen] PIN 인증 완료, 계좌 변경 진행');
        // PIN 인증 성공 시 은행 선택 모달 표시
        _showBankSelectionSheet();
      },
      onCancel: () {
        print('[ParentAccountLinkScreen] PIN 인증 취소됨');
      },
    );
  }

  // 은행 선택 화면으로 이동 (모달이 아닌 기존 그리드 화면 사용)
  void _showBankSelectionSheet() {
    // 계좌 변경 상태를 표시하고 기존 그리드 화면 재사용
    setState(() {
      _linkedAccount = null; // 계좌 변경 모드로 전환
    });
  }
  ...
  void _showAccountVerificationModal() {
    showModalBottomSheet(
      ...
      isDismissible: false,
      builder: (context) {
        return ParentAccountVerificationModal(
