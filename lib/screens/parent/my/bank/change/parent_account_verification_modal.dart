...
class ParentAccountVerificationModal extends StatefulWidget {
  final String selectedBank;
  final String selectedBankCode;
  final VoidCallback onPrevious;
  final VoidCallback onComplete;

  const ParentAccountVerificationModal({
    super.key,
  ...
  @override
  State<ParentAccountVerificationModal> createState() =>
      _ParentAccountVerificationModalState();
}

class _ParentAccountVerificationModalState
    extends State<ParentAccountVerificationModal> {
