...
class _BankSelectionBottomSheetState extends State<BankSelectionBottomSheet> {
  ...
  final List<Map<String, String>> securities = [
    ...
    {'name': '삼성증권', 'code': '240', 'logo': 'assets/logos/samsung_securities.png'},
    {'name': '한국투자증권', 'code': '243', 'logo': 'assets/logos/korea_investment.png'},
    ...
    {'name': '신한투자증권', 'code': '278', 'logo': 'assets/logos/shinhan_investment.png'},
    {'name': 'KB증권', 'code': '218', 'logo': 'assets/logos/kb_securities.png'},
    {'name': '토스증권', 'code': '271', 'logo': 'assets/logos/toss_securities.png'},
    {'name': '카카오페이증권', 'code': '288', 'logo': 'assets/logos/kakaopay_securities.png'},
        ...
        children: [
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            fontSize: 14,
                            fontFamily: isBankTab ? 'Pretendard-Bold' : 'Pretendard-Light',
                            letterSpacing: -0.28,
                          ),
                        ),
                        SizedBox(height: 8),
                  ...
                  children: [
                    Image.asset(
                      ...
                      errorBuilder: (context, error, stackTrace) {
                        return Icon(Icons.search, size: 24, color: Color(0xFF8096BA));
                      },
                    ),
                    SizedBox(width: 12),
                                         Expanded(
                       child: TextField(
                         ...
                         decoration: InputDecoration(
                           ...
                           hintText: isBankTab ? '연결하고 싶은 은행을 검색해주세요' : '연결하고 싶은 증권사를 검색해주세요',
                           hintStyle: TextStyle(
          ...
          Expanded(
            child: Container(
              ...
              child: filteredItems.isEmpty && searchText.isNotEmpty
                  ? Center(
                      child: Column(
                  ...
                  : GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final item = filteredItems[index];
                           ...
                           onTap: () {
                             widget.onBankSelected(item['name']!, item['code']!);
                           },
                           child: Container(
                             width: double.infinity,
