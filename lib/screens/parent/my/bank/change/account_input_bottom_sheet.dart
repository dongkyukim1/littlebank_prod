...
class AccountInputBottomSheet extends StatefulWidget {
  ...
  @override
  State<AccountInputBottomSheet> createState() => _AccountInputBottomSheetState();
}
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                      '${widget.selectedBank}의 정보를 입력해 주세요',
                      style: TextStyle(
                          ...
                          if (_accountController.text.isNotEmpty)
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                height: 24,
                                child: Image.asset(
                                  'assets/icons/parent/bank/delete.png',
                                  width: 20,
                                  height: 20,
                                ),
                              ),
                    ...
                    Container(
                      ...
                      decoration: ShapeDecoration(
                        ...
                        shape: RoundedRectangleBorder(
                          side: BorderSide(
                            width: 1.40,
                            color: _holderFocusNode.hasFocus 
                              ? const Color(0xFF5D9EFF)
                              : const Color(0xFFE8EDF7),
                          ),
                          borderRadius: BorderRadius.circular(16),
                        ...
                        child: _isVerifying
                          ...
                          : _isVerified
                            ? Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/icons/parent/bank/check_fill.png',
                                    width: 20,
                                    height: 20,
                                  ),
                                  SizedBox(width: 8),
                            ...
                            : Text(
                                '계좌 인증하기',
                                style: TextStyle(
                                  color: (_accountController.text.isNotEmpty && 
                                         _holderController.text.isNotEmpty)
                                    ? Colors.white
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text(
                          '다음',
                          style: TextStyle(
                            color: _canProceed ? Colors.white : const Color(0xFF8490A3),
                            fontSize: 12,
                            fontFamily: 'Pretendard-Medium',
                            letterSpacing: -0.24,
                          ),
