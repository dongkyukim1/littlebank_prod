...
import 'pin_input_bottom_sheet.dart';
    ...
    showModalBottomSheet(
      ...
      builder:
          (context) => PinInputBottomSheet(
            title:
                widget.isWithdrawal ? '출금 비밀번호를 입력해 주세요' : '결제 비밀번호를 입력해 주세요',
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                // 사용자 정보
                widget.isWithdrawal
                    ? // 출금 모드: 자기 자신의 정보만 가운데 정렬
                    Center(
                      child: _buildUserInfo(
                        name: currentUserName,
                        phone: _currentUserInfo?['phone'] ?? widget.senderPhone,
                        userInfo: _currentUserInfo,
                        fallbackImage: 'assets/icons/my/default_profile.png',
                        isLeft: true,
                      ),
                    )
                    : // 송금 모드: 기존 UI (보내는 사람 -> 받는 사람)
                    Container(
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text(
                  widget.isWithdrawal ? '이대로 출금하기' : '이대로 보내기',
                  style: TextStyle(
