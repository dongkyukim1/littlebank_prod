...
import '../../cs/parent_usage_inquiry_screen.dart';
import '../../cs/parent_suggestion_screen.dart';
import '../benefit/little_bank_benefits_screen.dart';

class ParentDeleteAccountScreen extends StatefulWidget {
  const ParentDeleteAccountScreen({super.key});

  @override
  State<ParentDeleteAccountScreen> createState() =>
      _ParentDeleteAccountScreenState();
}

class _ParentDeleteAccountScreenState extends State<ParentDeleteAccountScreen>
  ...
  final List<Map<String, String>> _reasons = [
    {
      ...
      'icon': 'assets/icons/parent/my/delete/feedback.png',
    },
    {
      'text': '미션, 챌린지 등 서비스 이용이 어려워요',
      'icon': 'assets/icons/parent/my/delete/report.png',
    },
    {
    ...
    {
      'text': '앱이 느리거나 오류가 잦아요',
      'icon': 'assets/icons/parent/my/delete/report.png',
    },
    {
      'text': '비슷한 다른 서비스를 이용 중이예요',
      'icon': 'assets/icons/parent/my/delete/money.png',
    },
    {'text': '기타', 'icon': 'assets/icons/parent/my/delete/feedback.png'},
  ];
                            ...
                            child: Column(
                              children: [
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      Positioned(
                                        left:
                                            65 -
                                            5, // 중앙에 위치 (박스 너비 130의 절반 - 삼각형 너비의 절반)
                                        top: 32,
                                        child: CustomPaint(
                                          size: Size(10, 8),
                                ...
                                Container(
                                  ...
                                  child: Image.asset(
                                    'assets/icons/parent/my/delete/logo.png',
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      _isLoadingUserInfo
                                          ? '이대로 탈퇴한다면 사용자님이 받았던 정보들과 함께 활동했던 소중한 순간들이 사라져요.'
                                          : '이대로 탈퇴한다면 ${_userName}님이 받았던 정보들과 함께 활동했던 소중한 순간들이 사라져요.',
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: [
                                    _buildFeatureItem(
                                      ' 활동 및 보상금을 전달할 수 있던 채팅',
                                      '자녀에게 제공할 미션만 작성하시면 전달은 저희가 빠르게 해드릴게요.',
                                      'assets/icons/parent/my/delete/money.png',
                                    ),
                                    const SizedBox(height: 20),
                                    _buildFeatureItem(
                                      '자녀에게 피드백을 제공할 수 있던 활동 평가',
                                      '미션뿐만 아니라, 매주 설정할 수 있는 목표도 칭찬 스탬프를 통해 격려하고 응원할 수 있어요.',
                                      'assets/icons/parent/my/delete/feedback.png',
                                    ),
                                    const SizedBox(height: 20),
                                    _buildFeatureItem(
                                      '자녀의 성장 과정을 볼 수 있던 분석 보고서',
                                      '자녀가 혼자서도 잘하고 있는지 걱정할 필요가 없어요. 저희가 자녀의 성장 과정을 알려드려요.',
                                      'assets/icons/parent/my/delete/report.png',
                                    ),
                                  ],
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    const SizedBox(height: 12),
                                    _buildCheckItem(
                                      '지금까지 드린 분석 보고서는 더이상 볼 수 없어요',
                                      '주기적으로 제공해 드렸던 자녀가 성장하는 과정을 지켜볼 수 있었던 분석 보고서는 탈퇴 시 더이상 볼 수 없어요.',
                                    ),
                                  ],
                                ),
                              ),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Image.asset(
                            _isConfirmed
                                ? 'assets/icons/parent/my/delete/fill_check.png'
                                : 'assets/icons/parent/my/delete/empty_check.png',
                            width: 20,
                            height: 20,
    ...
    return Row(
      ...
      children: [
        Image.asset(
          ...
          fit: BoxFit.contain,
          errorBuilder: (context, error, stackTrace) {
            print('이미지 로드 실패: $iconPath, 에러: $error');
            return Container(
              width: 48,
              height: 48,
              decoration: BoxDecoration(
    ...
    switch (_selectedReason) {
      ...
      case '미션, 챌린지 등 서비스 이용이 어려워요':
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const ParentUsageInquiryScreen(),
          ),
        );
        break;
      ...
      case '앱이 느리거나 오류가 잦아요':
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const ParentSuggestionScreen(),
          ),
        );
        break;
