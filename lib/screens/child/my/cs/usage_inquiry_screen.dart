...
class _UsageInquiryScreenState extends State<UsageInquiryScreen> {
  ...
  // 카테고리 목록
  final List<String> _categories = ['기능 문의', '계정 관리', '기록 관리', '로그인/오류'];
  ...
  final List<Map<String, String>> _faqs = [
    ...
    {
      'category': '계정 관리',
      'question': '닉네임 변경은 어디서 하나요?',
    },
    {
      'category': '기록 관리',
      'question': '활동 기록을 삭제할 수 있나요?',
    },
    {
      'category': '기록 관리',
      'question': '거래 내역을 확인하는 방법이 궁금해요',
    },
    {
      'category': '로그인/오류',
