...
class ChildBankSelectionModal extends StatefulWidget {
  ...
  @override
  State<ChildBankSelectionModal> createState() =>
      _ChildBankSelectionModalState();
}

class _ChildBankSelectionModalState extends State<ChildBankSelectionModal> {
  String searchText = '';
          ...
          Container(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Icon(Icons.search, size: 24, color: Colors.grey[400]),
                    SizedBox(width: 12),
                    Expanded(
                      child: TextField(
