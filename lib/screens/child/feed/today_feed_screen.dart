...
class _TodayFeedScreenState extends State<TodayFeedScreen> {
  ...
  // 태그 카테고리 목록
  final List<String> _tagCategories = ['학습인증', '습관형성'];
  final List<String> _tagCategoryValues = [
    'STUDY_CERTIFICATION',
    'HABIT_BUILDING',
  ];
  ...
  Future<void> _loadUserInfo() async {
    ...
    try {
      ...
      if (userInfo.containsKey('gradeCategory')) {
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            if (tempSelectedIndex == 1) ...[
                                              SizedBox(width: 4),
                                              Image.asset(
                                                'assets/icons/Icon/feed/check_fill.png',
                                                width: 16,
                                                height: 16,
                                              ),
                                            ],
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(color: Color(0xFFF0F2F7)),
      child: Column(
        children: [
  ...
  Widget _buildUpdatedPopularFeedCard(dynamic feed) {
    ...
    return GestureDetector(
      ...
      child: Container(
        width: 240,
        height: 224, // 사용자 제공 코드와 동일한 높이
        margin: EdgeInsets.only(top: 8, bottom: 20), // 아래쪽 마진 유지
        decoration: BoxDecoration(
          boxShadow: [
            BoxShadow(
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      for (
                        int i = 0;
                        i < (imageUrls.length > 2 ? 2 : imageUrls.length);
                        i++
                      )
                        Container(
                          width: 44,
                        ...
                        decoration: BoxDecoration(
                          ...
                          image:
                              profileImageUrl.isNotEmpty
                                  ? DecorationImage(
                                    image: NetworkImage(AuthService.getFullProfileImageUrl(profileImageUrl)),
                                    fit: BoxFit.cover,
                                  )
                                  : null,
                        ),
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: hasImage 
                ...
                : AssetImage('assets/icons/Icon/feed/empty.png') as ImageProvider,
            fit: BoxFit.cover,
          ),
        ),
        child: Container(
          ...
          decoration: ShapeDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                const Color(0x18146AFF),
                const Color(0x40146AFF),
              ], // 더 투명한 오버레이
            ),
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(20),
