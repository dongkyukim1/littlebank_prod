...
class _ChatListScreenState extends State<ChatListScreen> {
  final List<ChatItem> _chatItems = [
    ChatItem(
      name: '엄마',
      message: '이번에는 특별히 만점이면 수고비를 좀 줄게~!',
      count: 1,
      avatar: '👩',
      time: '어제',
    ),
    ...
    ChatItem(
      name: '알림',
      message: '태현이의 아이폰을 위하여! 미션이 등록되었습니다',
      count: 3,
      avatar: '🔔',
      time: '15:42',
    ),
    ChatItem(
      name: '스티븐',
      message: '새로운 포스터 디자인 트렌드를 만들고 있어요.',
      count: 0,
      avatar: '👨',
      time: '11/12',
    ),
      ...
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder:
                (context) =>
                    ChatDetailScreen(userName: item.name, avatar: item.avatar),
          ),
        );
      },
      child: Container(
